...
APIMART_BASE_URL=            # Optional host override; default https://api.apimart.ai
...
Veo 3.1 (conservative estimates); other models estimate 0. Every result reports
the actual USD charge APIMart returns on the finished task. Local images are uploaded automatically; reference videos
